        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="hidden md:block lg:block bg-primaryColor rounded-l-lg">
            <figure className="rounded-l-lg">
              <img src={signupImg} alt="signup" className="rounded-l-lg w-full" />
            </figure>
          </div>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center gap-3">
                  ...
                  <figure className="w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
                    <img src={avatar} alt="doctor" className="w-full rounded-full" />  {/* circle avatar next to the upload photo */}
                  </figure>
              ...
              <div className="mt-7">
                <button disabled={loading && true} className="btn w-full rounded-md"
                 type="submit">{loading ? <HashLoader size={35} color='#ffffff'/>
                 :"Sign up"}</button>
              </div>
