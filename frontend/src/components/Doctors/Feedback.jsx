  ...
  return (
    <div>
        <div className="mb-[50px] ">
            ...
            <div>
                <div className="flex gap-1"> {/* creates the stars next to the reviews */}
        ...
        {/** Button for feedbackForm */}
        {!showFeedbackForm && (
            <div className="text-center">
                <button className='btn' onClick={()=>setShowFeedbackForm(true)} >Give Feedback</button>
            </div>
        )}
{/* this line has to be in the beginning line  */}
{/** Shows feedbackForm when button clicked  */}
